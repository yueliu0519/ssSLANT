...
parser.add_argument('--fineepoch', type=int, default=4, help='fine tuning starting epoch')
...
#working_dir = os.path.join('/nfs/masi/liuy108/SLANTFTticv/working_dir/', piece)
#test_img_dir = '/home/liuy108/codes/SLANTMS/testing'
#finetune_img_dir = '/home/liuy108/codes/SLANTMS/finetune/image'
#finetune_seg_dir = '/home/liuy108/codes/SLANTMS/finetune/label'
finetune_img_dir = '/opt/slant/matlab/output_pre/FinalResult'
finetune_seg_dir = '/opt/slant/matlab/output_pre/FinalResult'
